    ...
    >
      <defs>
        <linearGradient id="koaInk" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#5ec0ff" />
          <stop offset="40%" stopColor="#2f8fdb" />
          <stop offset="100%" stopColor="#163f66" />
        </linearGradient>
        ...
        <linearGradient id="koaAccent" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#7ed0ff" stopOpacity="0" />
          <stop offset="50%" stopColor="#3aa0e8" stopOpacity="0.85" />
          <stop offset="100%" stopColor="#1f5f96" stopOpacity="0" />
        </linearGradient>
      </defs>

      {/* 背景淡晕 */}
      <ellipse cx="48" cy="22" rx="42" ry="14" fill="#2f8fdb" opacity="0.07" />
      ...
      {/* 装饰点 */}
      <circle cx="94" cy="33.5" r="1.35" fill="#2f8fdb" opacity="0.7" />
      <circle cx="97.2" cy="30.8" r="0.85" fill="#5ec0ff" opacity="0.55" />
      <circle cx="14" cy="7" r="0.9" fill="#5ec0ff" opacity="0.4" />
      <circle cx="58" cy="8.5" r="0.7" fill="#2f8fdb" opacity="0.35" />
    </svg>
  )
}
